...
var fs, fsExtra, path, yargs, nodeSass, cleanCss, scssSymbolsParser, colors, argv, vardir, files, outdir, twbsRoots, twbsRoot, originVarfile, varfile, variables;
fs = require('fs');
...
if (fs.existsSync(path.join(vardir, '_variables.scss'))) {
  console.log("since 0.0.7, we use `_custom.scss` instead of `_variables.scss` unless you want to overwrite the default `_variables.scss` file completely, which is unlikely to happen.".yellow);
}
